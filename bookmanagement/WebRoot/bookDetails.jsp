...
<body>
	 ...
	 <div id="heads">
	   ...
	   <div id="bodyer">
		...
		<p style="color:red; font-size:26px;" id="i1">BookDetails</p>
		<br></div>
		    ...
		    <%
         	...
         	%>
         	  <%
              if(id==null){
               id=(String)request.getAttribute("id2");
               if(id!=null){
               %>
                 <script>alert("添加购物车成功")</script>
               <% 
               }
              }
             %>
         ...
         <div id="d2">
         	...
         	<table cellspacing="30px">
         		<tr>
         			<td><img src=<%=img%> height="150" width="98"></td>
        ...
        <h4>具体介绍：</h4     >
           ...
           <input type="hidden" value="<%=id%>" name="bookId"></input> 
            
            <ul type="circle">
              <li name="goods_name">书名:<%=book.getBookname()%></li>
              <li>ISBN：<%=book.getIsbn() %></li>
              <li>价格：<%=book.getPrice() %></li>
              <li>出版社：<%=book.getPublish() %></li>
            </ul><div style="margin-left:200px; margin-top:30px;width: 213px">
				<button type="submit" style="width: 163px; height: 35px; background-image:url('images/gouwuche_logo.png'); border:0px;"> </button><br><br>
				<a href="userBooks"><input type="button" value="返          回" style="background-color:#ff0036; width: 163px; height: 35px;border:none;color:white; font-size:17px; "></a>
          </div>
