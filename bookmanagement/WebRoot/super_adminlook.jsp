...
<body>
	...
	<div id="d1">
		 <th><h2 id="z1" style="text-align:center">超级管理员</h2></th>
       ...
       <div class="result-wrap" align="center">
          ...
          <div style="margin-left:650px;"><a href="super_admin.jsp" id="d4"><input type="button" value="返回"/></a>&nbsp;&nbsp;&nbsp;<a href="login.jsp" id="d4"><input type="button" value="退出"/></a></div>
    </div>
