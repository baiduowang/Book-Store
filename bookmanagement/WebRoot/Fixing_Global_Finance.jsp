...
<body>
	 ...
	 <div id="heads">
	     ...
	     <span><a href="my_account.html">my account</a></span>&nbsp;&nbsp;
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="books.jsp"><input type="button"  value="return"/></a>
	      </div>
	   ...
	   <div id="bodyer">
		...
		<p style="color:red;" id="i1">Fixing Global Finance</p>
		<br></div>
		...
		<form action="#" method="post">
         <div id="d2">
         	...
         	<table cellspacing="30px">
         		<tr>
         			<td><img src="images/thumb2.gif" height="150" width="98"></td>
         			<td class="t1" valign="top"> <img src="images/special_icon.gif" class="r1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam voluptatibus nihil tempora enim laudantium rem placeat odit esse facere ut impedit adipisci voluptate voluptatem quae minus dolorum corrupti, hic iusto.
         			</td>
         		</tr>  
          ...
          <div id="add">
        <h4>具体介绍：</h4>
           <input type="hidden" value="<%=book.getBookname()%>" name="Bookname"></input> 
           <input type="hidden" value="<%=book.getIsbn()%>" name="Isbn"></input> 
           <input type="hidden" value="<%=book.getPrice()%>" name="Price"></input> 
           <input type="hidden" value="<%=book.getPublish()%>" name="Publish"></input>
            
            <ul type="circle">
             <li>书名:<%=book.getBookname() %></li>
             <li>ISBN：<%=book.getIsbn() %>              </li>
              <li>价格：<%=book.getPrice() %>           </li>
              <li>出版社：<%=book.getPublish() %>          </li>
</ul>  

          </div>
          <div style="margin-left:300px;">
				<button type="submit" style="width: 163px; height: 35px; background-image:url('images/gouwuche_logo.png'); border:0px;" > </button>
          </div>
         </div>
         </form>
